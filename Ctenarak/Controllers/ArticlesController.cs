...
namespace Ctenarak.Controllers
{
    public class ArticlesController : Controller
    {
        ...
        [Authorize(Roles = "Admin, Creator")]
        public async Task<IActionResult> Create([Bind("Id,Obsah,Titulek,Popis")] Article article)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Admin, Creator")]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Obsah,Titulek,Popis")] Article article)
        {
            if (id != article.Id)
            {
                return NotFound();
